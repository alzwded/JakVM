...
%token STRING ASM EOL ADDRESS IMEDIATE REGISTER OTHER WS_PART NONE HEX HEOF COMMA

%type <stringy> STRING ASM EOL ADDRESS IMEDIATE REGISTER OTHER WS_PART NONE HEX HEOF COMMA
%type <stringy> param
