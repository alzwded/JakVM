...
file:   STACK_DIRECTIVE DATA_SEGMENT PRE_SEGMENT CODE_SEGMENT 
    |   STACK_DIRECTIVE CODE_SEGMENT
    |   STACK_DIRECTIVE PRE_SEGMENT CODE_SEGMENT
    |   STACK_DIRECTIVE DATA_SEGMENT CODE_SEGMENT
    |   STACK_DIRECTIVE DATA_SEGMENT PRE_SEGMENT
    |   STACK_DIRECTIVE DATA_SEGMENT
    |   STACK_DIRECTIVE PRE_SEGMENT
    ;
...
PRE_SEGMENT:        '.pre' EOL
    |               '.pre' EOL PRE_SEGMENT_BODY
    ;

PRE_SEGMENT_BODY:   PRE_SEGMENT_BODY ATOMIC_DATA
    |               ATOMIC_DATA
    ;
